...
//post "币币管理" => 查询充币总数
export const findAll = (startTime,endTime) => fetch(`/admin/finance/member-deposit/getSum/${startTime}/${endTime}`);

//GET获取 "财务管理"=>"提币管理(记录)"
export const withdrawManage = data => fetch('admin/finance/withdraw-record/page-query', data);

export const coinGetAllNum = (start, end) => fetch(`admin/finance/withdraw-record/getArrivedAmount/${start}/${end}`);
...
//Post "内容管理" => "帮助管理"
export const helpManage = data => postConfig('admin/cms/system-help/page-query', data);

//Post "内容管理" => "帮助管理"=>"置顶"
export const stickTopHelp = data => post('admin/cms/system-help/top', data);

//Post "内容管理" => "添加帮助管理"
export const addHelpManage = data => postConfig('admin/cms/system-help/create', data);
...
//Post "内容管理" => "更新帮助管理"
export const updateHelpManage = data => postConfig('admin/cms/system-help/update', data);
...
//Get "会员管理" => "获取用户等级对应人数"
export const memberLevel = data => fetch(`/admin/admin/currentLevelCount`);
...
//POST "教汇通产品" => "机构管理"
export const mechanismAdministration = data => postConfig('admin/product/organ/page-query', data);

//POST "教汇通产品" => "添加机构管理"
export const addmechanism = data => postConfig('admin/product/organ/create', data);
//POST "教汇通产品" => "更新机构管理"
export const editormechanism = data => postConfig('admin/product/organ/update', data);

// get "教汇通产品" => "删除机构"
export const deletemechanism = (id, data) => fetch(`admin/product/organ/delete/${id}`, data);

//POST "教汇通产品" => "分类名称"
export const classificationAdministration = data => postConfig('admin/product/cate/page-query', data);

//POST "教汇通产品" => "新增分类"
export const addclassification = data => postConfig('admin/product/cate/create', data);
//POST "教汇通产品" => "更新分类信息"
export const editorclassification = data => postConfig('admin/product/cate/update', data);

// get "教汇通产品" => "删除分类"
export const deleteclassification = (id, data) => fetch(`admin/product/cate/delete/${id}`, data);

// get "教汇通产品管理" => "所属分类"
export const belongtype = data => fetch(`admin/product/all/cate`, data);

//get  "教汇通产品管理" => "所属机构"、
export const allOrgan = data => fetch(`admin/product/all/organ`, data);

//get  "教汇通产品管理" => "查询数据接口"
export const productdata = data => postConfig("admin/product/pro/page-query", data);

//post "教汇通产品管理" => "添加产品"
export const addductdataApi = data => postConfig("admin/product/pro/create", data);

//post "教汇通产品管理" => "修改产品"
export const editorpuctdataApi = data => postConfig("admin/product/pro/update", data);

//post "教汇通产品管理" => 根据做市商ID查询用户是否存在
export const checkUserExistenceApi = (id, data) => fetch(`admin/product/pro/market/${id}`, data);

//post "教汇通增发模块" => 查询接口
export const increasePageQuery = data => postConfig("admin/increase/query_prod", data);

// get  教汇通增发模块 => 查询所有上架产品信息
export const allProductDetail = data => fetch(`admin/increase/query_prod`, data);

// get  教汇通增发模块 => 根据用户id查询用户是否存在
export const checkUser = (id, data) => fetch(`admin/increase/query_member/${id}`, data);

//POST "教汇通增发模块" => "添加增发记录"
export const addProductRecord = data => postConfig('admin/increase/add_product', data);

//POST "教汇通增发模块" => "审核是否通过"
export const reviewIncrease = data => postConfig('admin/increase/review', data);

//POST "教汇通报表模块" => "汇总查询"
export const ReportFormAll = data => postConfig('admin/report/turnover/count', data);

//POST "教汇通报表模块" => "B1表查询"
export const ReportBFormOne = data => postConfig('admin/report/turnover/date', data);

//POST "教汇通报表模块" => "B2表查询"
export const ReportBFormTwo = data => postConfig('admin/report/turnover/pronum', data);
...
//POST获取 "系统管理"=>"平台设置"=>"获取app信息"
export const getAppInfo = data => fetch('/admin/app/version', data);

//POST获取 "系统管理"=>"平台设置"=>"获取app图片"
export const getAppImages = data => fetch('/admin/app/pic', data);

//POST获取 "系统管理"=>"平台设置"=>"更新app版本信息"
export const updateAppInfo = data => postConfig('/admin/app/version/update', data);

//POST获取 "系统管理"=>"平台设置"=>"更新app图片信息"
export const updateAppImages = data => postConfig('/admin/app/pic/update', data);
...
//获取米=买卖单数量
export const getOrdrNumApi = data => post('admin/exchange/exchange-order/getCount', data);

//post "教汇通订单管理查询接口=>"撤销"
export const cancelOrder = data => post('admin/exchange/exchange-order/cancel', data);

//postConfig 获取静态收益明细接口
export const staticG = data => postConfig('/admin/admin/staticGains', data);

//get 获取当日静态收益总量接口
export const staticN = url => fetch(`/admin/admin/getAmount/${url}`);

//postConfig 获取动态收益明细接口
export const dynamicG = data => postConfig('/admin/admin/dynamicBenefits', data);

//get 获取当日动态收益总量接口
export const dynamicN = url => fetch(`/admin/admin/dynamicForDay/${url}`);

//postConfig获取 "财务管理"=>"手续费管理"
...
//postConfig获取 "系统管理"=>"币价配置删除"
export const deleteApi = data => postConfig("/admin/coin/price/delete", data);

//postConfig获取 "系统管理"=>"建议反馈"
export const adviceApi = data => postConfig("/admin/sugg/sugg/page-query", data);

//GET "财务管理"=>"持币量管理"
export const accountSumApi = data => fetch(`/admin/admin/accountSum/${data.pageNo}/${data.pageSize}/${data.type}`);

//post "收益释放管理"=>"收益折扣配置"
export const discountApi = data => postConfig("/admin/income/discount/save", data);

//post "收益释放管理"=>"收益折扣修改"
export const fixDiscountApi = data => postConfig("/admin/income/discount/update", data);

//post "收益释放管理"=>"收益折扣删除"
export const deleteDiscountApi = data => postConfig("/admin/income/discount/delete", data);

//get "系统管理"=>"同步账户"
export const accountSyncApi = url => fetch(`/admin/admin/synchronousAccount/${userId}/${username}`);

//post "系统管理"=>"同步账户"
export const accountSyncSee = data => postConfig("/admin/admin/pageSynchronous", data);